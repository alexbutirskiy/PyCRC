...
PyCRC could always use more documentation, whether as part of the
official PyCRC docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.3, and 3.4, and for PyPy. Check
   https://travis-ci.org/cristianav/PyCRC/pull_requests
